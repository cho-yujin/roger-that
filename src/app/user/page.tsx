  ...
  return (
    <div>
      ...
      <div className="flex justify-between gap-6">
        <div className="w-[50%] bg-white border border-outlineGray rounded-2xl">
          <div className="grid grid-cols-1 gap-y-3 justify-between pt-7 px-6">
            ...
            <div className="grid grid-cols-[7%_93%]">
              ...
              <div className="flex flex-col">
                <div className="basis-1/4 w-[52px] h-[30px] text-center text-[#121212] text-base font-medium font-['Bricolage Grotesque']">TUES</div>
              ...
              <div className="pl-10 flex flex-col gap-y-2 content-center items-left justify-center justify-self-end row-span-2 w-[95%] h-[147px] bg-[#f8f8ff] rounded-[30px] border border-[#b6b9ec]">
                <div className="flex items-center gap-x-2">
                  <div className="w-3 h-3 bg-[#fd88d0] rounded-full" />
                  <div className="text-[#121212] text-xl font-bold font-['Bricolage Grotesque']">ASUCD Coffee House</div>
                </div>
                ...
                <div className="flex gap-1.5">
                  ...
                  <div className="text-[#8a8a8a] text-xs font-normal font-['Bricolage Grotesque']">UC Davis Memorial Union  |</div>
                  ...
                  <div className="text-[#8a8a8a] text-xs font-normal font-['Bricolage Grotesque']">3 hours</div>
                </div>
              </div>
            </div>
        ...
        <div className="w-[50%] h-[100vh] bg-white border border-outlineGray rounded-2xl">
